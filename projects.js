...
const PROJECTS = [
  ...
  },
  {
    ...
    pivots: [
      ...
      },
      {
        ...
        body: "처음에는 지운 칸 수로만 난이도를 나눴는데, 힌트가 적어도 쉬운 판이 나올 수 있어서 체감과 어긋났습니다. 싱글·잠긴 후보·페어·X-윙 같은 사람이 쓰는 기법으로 직접 풀어보고, 필요한 기법으로 난이도를 매기도록 바꿨습니다. 60일치 시험에서 58일이 목표 난이도에 맞았고, 못 맞춘 날은 실제 채점 결과대로 표기합니다."
      }
    ],
    skills: [
      "시드 기반 절차적 생성 (PRNG)",
  ...
  },
  {
    id: "daily-jigsaw",
    name: "오늘의 직소",
    tagline: "그림도 조각도 날짜로 생성되는 데일리 직소 퍼즐",
    year: "2026",
    tags: ["Web App", "Game", "Solo"],
    accent: "#3182F6",
    accent2: "#F04452",
    cover: { type: "iframe", src: "https://daily-jigsaw.vercel.app" },
    description:
      "협동 직소 사이트를 보고 떠올린 혼자 푸는 데일리 직소입니다. 그림과 조각 모양을 모두 날짜를 시드로 브라우저에서 생성하기 때문에 이미지 파일도 서버도 없고, 요일마다 조각 수가 달라집니다.",
    stats: [
      { n: "0개", l: "서버 · DB · 이미지 파일" },
      { n: "12–30", l: "요일별 조각 수" },
      { n: "7일", l: "지난 그림 다시 맞추기" }
    ...
    pivots: [
      {
        n: "01",
        title: "협동 직소 → 혼자 푸는 데일리 직소",
        body: "참고한 사이트의 핵심은 실시간 협동인데, 웹소켓 서버가 필요해서 지금의 정적 배포 구조와 맞지 않았습니다. 1단계는 혼자 푸는 직소로 범위를 좁히고, 협동 모드는 나중에 서버를 붙이는 확장으로 남겨뒀습니다."
      },
      {
        n: "02",
        title: "이미지 파일 → 날짜로 생성한 그림",
        body: "사진을 쓰면 저작권과 파일 관리가 따라와서, 날짜를 시드로 큰 색면·도형·잔 질감을 겹쳐 그림을 생성했습니다. 조각끼리 구분이 안 되면 퍼즐이 성립하지 않아서, 단색 영역이 생기지 않게 질감 레이어를 따로 더했습니다."
      },
      {
        n: "03",
    ...
    links: {
      live: "https://daily-jigsaw.vercel.app"
    }
  }
];
